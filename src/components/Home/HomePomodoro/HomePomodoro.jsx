  ...
  if (isPomodoroOpenOfPomodoroClockStore) {
    return (
      <S.PomodoroWrapper isBig={isPomodoroOpenOfPomodoroClockStore}>
        <S.OpenWrapper>
          <S.Toggle onClick={() => dispatch(setIsPomodoroOpen(false))}>
          ...
          <S.TaskCard>
            ...
            <div>
              ...
              <p>
                完成：{selectCountdownTask.totalSpendTime} / 預期：
          ...
          <S.PomodoroClock>
            <HomePomodoroClock isBig={true} time={timer.countDownTime} />
          </S.PomodoroClock>
          <S.PomodoroToggleButtonWrapper>
            {timer.isStart ? (
              ...
              <S.Button onClick={() => dispatch(startCountdown())}>
