...
function HomeEditForm({ onClose = () => {}, onDeleteTask = () => {} }) {
    ...
    const submitForm = handleSubmit((value) => {
        const { cacheTotalSpendTime, cacheExpectEndDate, cacheFolder, cacheSubtask, ...taskData } =
            {
                ...selectUpdateTask,
                ...value,
            }
    ...
    return (
        <EditForm className="home-edit">
            <Item as="div" alignItems="space-between">
                ...
                <Checkbox></Checkbox>
                <CommonInput attributes={{}} errorMessage="" label="name" register={register} />
            </Item>
            <Line></Line>
            <List>
                <Item>
                    ...
                    >
                        ...
                        <CommonButton
                            color="green"
                            onClick={() => {
                                setValue('totalSpendTime', watch('cacheTotalSpendTime'))
                                setIsPomodoroModalOpen(!isPomodoroModalOpen)
                            }}
                            type="block"
                        >
                ...
                <Item>
                    ...
                    <CommonPopover
                        text={
                            watch('expectEndDate')
                                ? dayjs(watch('expectEndDate')).format('YYYY/MM/DD')
                                : '無'
                        }
                    ...
                    >
                        ...
                        <CommonButton
                            color="green"
                            onClick={() => {
                                setValue('expectEndDate', watch('cacheExpectEndDate'))
                                setIsTotalExpectOpen(!isTotalExpectOpen)
                            }}
                            type="block"
                        >
                ...
                <Item>
                    ...
                    <CommonPopover
                        text={
                            watch('mentionDate')
                                ? dayjs(watch('mentionDate')).format('YYYY/MM/DD')
                                : '無'
                        }
                    ...
                    >
                        ...
                        <CommonButton
                            color="green"
                            onClick={() => {
                                setValue('mentionDate', watch('cacheMentionDate'))
                                setIsMentionDateOpen(!isMentionDateOpen)
                            }}
                            type="block"
                        >
                ...
                <Item>
                    ...
                    <Button
                        onClick={() => {
                            ...
                            const data = [...watch('subtasks'), watch('cacheSubtask')]
            ...
            <Line></Line>
            <Textarea placeholder="填寫內容" {...register('description')}></Textarea>
            <Line></Line>
            <Item as="div" lastNotFloat={true} alignItems="space-between">
                ...
                <Text>創建於 {dayjs(selectUpdateTask.createAt).format('YYYY/MM/DD')} 日</Text>
                <Button
                    onClick={() => {
